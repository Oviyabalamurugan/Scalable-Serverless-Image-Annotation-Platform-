• Built a scalable, cloud-native backend platform using EC2 Auto Scaling, Application Load Balancer (ALB), and serverless
components (S3, Lambda, RDS MySQL) to support high-availability workflows.
• Implemented event-driven backend processing using EventBridge triggers on S3 ObjectCreated events, enabling
real-time and scalable execution.
